...
# I think the model performed well looking at the SVM classification plot. The boundaries almost distinctly classifies the three categories. Also the misclassification rate is pretty less i.e. about 0.02.

#What is the accuracy rate?
# Ans: 97.33%
100*mean(pred==iris$Species)
